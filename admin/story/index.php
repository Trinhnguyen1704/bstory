                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                   <?php 
                                        $sqlStory = "SELECT s.*,c.name as nameCat FROM story as s INNER JOIN cat as c ON c.cat_id=s.cat_id ORDER BY s.story_id DESC ";
                                    ...
                                    <tr class="<?php echo $cl?> gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo $urlDel?>" title="" class="btn btn-danger" onclickf="return confirm('Ban co chac muon xoa khong ?')"><i class="fa fa-pencil"></i> Xóa</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="text-align: right;">
                                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button previous disabled" aria-controls="dataTables-example" tabindex="0" id="dataTables-example_previous"><a href="index.php?page=<?php echo $i-1;?>">Trang trước</a></li>
